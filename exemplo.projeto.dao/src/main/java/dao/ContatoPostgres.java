...
public class ContatoPostgres implements ContatoDAO {
	...
	public void add(Contato contato) {
		try {
			...
			String stringDeInsercaoContato = "insert into contatos (nome, cpf) values ( ?, ?) returning id_contato"; 
			String stringDeInsercaoTelefone = "insert into telefones (id_contato, numero, tipo) values ( ?, ?, ?)";
			
			PreparedStatement inserirContato = connection.prepareStatement(stringDeInsercaoContato);			
